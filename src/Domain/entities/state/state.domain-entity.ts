...
import { InitialStateValueObject } from '../../value-objects/state-initials/state-initials.value-object';
import { StateProps } from './state.domain-entity-interface';
import { ERROR_STATE_DESCRIPTION_LENGTH } from './state-errors.domain.entity';
...
export class State extends Entity<StateProps> {
	...
	public static create(
		...
		const uppercaseDescription = transformStringToUpperCase(
			props.description
		);
