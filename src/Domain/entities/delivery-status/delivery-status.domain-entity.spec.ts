...
import { DeliveryStatus } from './delivery-status.domain-entity';
...
import { DeliveryStatusId } from './delivery-status-id.domain-entity';
...
describe('DeliveryStatus.domain-entity', () => {
  ...
  it('Should fail if provide a long info description length more than max permited', () => {
    const validDeliveryStatus = DeliveryStatus.create({
      ...
      info: 'Lorem Ipsum dola this-is-a-long-DeliveryStatus-invalid-description-to-check-the-validation Lorem ',
    });
