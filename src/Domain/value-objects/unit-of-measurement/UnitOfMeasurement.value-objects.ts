...
import { ERROR_INVALID_ENUM_FOR_UNIT_OF_MEASUREMENT } from './UnitOfMeasurementErrors.domain';
...
export class UnitOfMeasurementValueObject extends ValueObject<UnitOfMeasurementProps> {
  ...
  public static create(unit: UnitTypes): Result<UnitOfMeasurementValueObject> {
